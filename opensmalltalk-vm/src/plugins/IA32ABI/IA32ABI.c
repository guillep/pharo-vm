/* Automatically generated by
	VMPluginCodeGenerator * VMMaker.oscog-GuillermoPolito.2244 uuid: 290987d9-8ba9-470a-b28a-ea9b02b551fc
   from
	IA32ABIPlugin * VMMaker.oscog-GuillermoPolito.2244 uuid: 290987d9-8ba9-470a-b28a-ea9b02b551fc
 */
static char __buildInfo[] = "IA32ABIPlugin * VMMaker.oscog-GuillermoPolito.2244 uuid: 290987d9-8ba9-470a-b28a-ea9b02b551fc " __DATE__ ;
...
EXPORT(sqInt) primReturnAsFromContextThrough2(void);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"IA32ABI * VMMaker.oscog-GuillermoPolito.2244 (i)"
#else
	"IA32ABI * VMMaker.oscog-GuillermoPolito.2244 (e)"
#endif
;
...
/*	Return a result from a callback to the callback's callee. The primitive
	...
	/* IA32ABIPlugin>>#primReturnAsFromContextThrough2 */
EXPORT(sqInt)
primReturnAsFromContextThrough2(void)
{
    int isMostRecent;
    VMCallbackContext *vmCallbackContext;
...
assert((methodArgumentCount()) == 2);
	...
	return (!(returnAsThroughCallbackContext2(stackValue(1), vmCallbackContext, stackValue(0)))
...
void* IA32ABI_exports[][3] = {
	...
	{(void*)_m, "primReturnAsFromContextThrough2\000\000", (void*)primReturnAsFromContextThrough2},
...
signed char primReturnAsFromContextThrough2AccessorDepth = 0;
